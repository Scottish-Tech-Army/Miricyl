...
Personalise page has footer section
    [Documentation]  Checks if footer data is is intact
    [Tags]  Smoke  functional  end-2end
    Index.Go to the MIRICYL home page
    Index.Click on the next button
    Index.Click on the next button
    Personalise.Ensure feedback text and link is present in the personalise page
    Personalise.Ensure Miricyl Address and Privacy Policy is present in the personalise
